          ...
          <div class="panel-body">
            <div class="bootstrap-table">
              <div class="table-responsive">
                <h3 style="color:#007bff !important">Quản lí sản phẩm - 
                  <a href="{{request()->fullUrlWithQuery(['type'=>'inventory'])}}" 
                  class="{{Request::get('type')=='inventory'||!Request::get('type') ? 'active' : ''}}">Hàng tồn</a> - 
                  <a href="{{request()->fullUrlWithQuery(['type'=>'pay'])}}" 
                  class="{{Request::get('type')=='pay' ? 'active' : ''}}">Bán Chạy</a></h3>

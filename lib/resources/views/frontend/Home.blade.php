						...
						@foreach($products as $item)
							...
							<div class="owl-item">
								<div class="trends_item is_new">
									<div class="trends_image d-flex flex-column align-items-center justify-content-center"><img src="{{asset('public/Hinh/'.$item->image)}}" alt=""></div>
									<div class="trends_content">
										<div class="trends_category"><a href="">{!! $item->name !!}</a></div>
										<div class="trends_info clearfix">
											<div class="trends_name"><a href="{{asset('Details/'.$item->id.'/'.$item->alias)}}">{!! $item->name !!}</a></div>
											<div class="trends_price">{!! number_format($item->price,0,',','.') !!}</div>
										</div>
									</div>
